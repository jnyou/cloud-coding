...
@Service
@Slf4j
public class GitHubLoginBiz implements ThirdLoginStrategy {
    ...
    public MemberInfoResp strategyLogin(SocialUserReq socialUserReq) {
        ...
        MemberEntity memberEntity = memberService.oauth2GithubLogin(socialUserReq);
